...
> 👩‍💻 Edit `packages/foundry/contracts/Vendor.sol` and build a token vending machine with a **payable** `buyTokens()` function.
...
📡 Deploy to a public testnet. We recommend `sepolia` or `optimismSepolia`.
